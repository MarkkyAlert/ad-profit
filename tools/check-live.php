...
$mustBlock = [
    ...
    /* ⚠️⚠️ ถ้า deploy ด้วย `git clone` โฟลเดอร์ `.git/` จะขึ้นไปด้วย
       และกฎที่กัน "ไฟล์ขึ้นต้นด้วยจุด" **กันไม่ได้** เพราะไฟล์ข้างในชื่อ
       `config`/`HEAD`/`index` ซึ่งไม่มีจุดนำหน้า · เป็นเป้าที่สแกนเนอร์ไล่หาก่อนเลย */
    '/.git/config' => '⚠️ ร้ายแรง — เปิดทางให้ดาวน์โหลดซอร์สโค้ดทั้งหมดย้อนหลัง',
    '/.git/HEAD' => '⚠️ ร้ายแรง — ประวัติซอร์สโค้ด',
