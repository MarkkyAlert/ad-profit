...
class GoalService
{
    ...
    public static function progressPercent(float $actual, ?float $target): ?float
    {
        ...
        /* ⚠️⚠️ **ปัดเข้าหาศูนย์ ไม่ใช่ปัดลงเสมอ**
           ✅ **[เจ้าของระบบตัดสิน 2026-08-10]**
           · ฝั่งบวก: ปัดเข้าหาศูนย์ = ปัดลง → คงคุณสมบัติเดิมไว้ครบ
             99.996% ยังไม่ขึ้นเป็น 100.0% ก่อนถึงเป้าจริง (ป้าย "ถึงเป้า" เทียบค่าจริงอยู่แล้ว)
