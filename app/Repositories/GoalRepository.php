...
class GoalRepository
{
     ...
     *
     * ⚠️⚠️ **ข้อความเดิมตรงนี้เขียนกฎกลับหัว** — เคยเขียนว่า "ล้างช่องหนึ่งให้ว่าง
     * = ลบเป้านั้น" ซึ่งไม่ตรงกับพฤติกรรมจริงมานานแล้ว
     *
     * ของจริง: `GoalService::upsertGoal()` อ่านค่าเดิมใต้ล็อกก่อน แล้วเติมให้ช่องที่
     * ส่งมาว่าง → **เว้นว่าง = คงค่าเดิม ไม่ใช่ลบ** (กันฟอร์มที่เปิดค้างไว้ล้างเป้า
     * ที่อีกแท็บเพิ่งตั้ง) · จะล้างทั้งเดือนต้องใช้ปุ่ม "ลบเป้าหมาย"
     *
     * เมธอดนี้ยังเขียนทับทั้ง 2 ฟิลด์เสมอตามเดิม — แต่ค่าที่ส่งเข้ามาถูกเติมมาแล้ว
     * จาก service ⚠️ ผู้เรียกที่ข้าม service มาเรียกตรง ๆ จะล้างฟิลด์ที่ไม่ได้ส่งเงียบ ๆ
     */
    /**
