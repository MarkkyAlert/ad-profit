...
if ($action === 'bulk_upsert') {
    ...
    /* ⚠️ ธงนี้บอกว่า "หน้าเว็บได้เห็นโน้ตเดิมของวันนั้นแล้ว" — เป็นภาพ ณ เวลาที่โหลด
       ✅ **[เจ้าของระบบตัดสิน 2026-08-10] ยอมรับได้ว่าสองแท็บแก้วันเดียวกันแล้วใครบันทึก
          ทีหลังชนะทั้งแถว** — ห้ามเพิ่มกลไกกันเรื่องนี้โดยไม่ถามก่อน (เหตุผลอยู่ใน CLAUDE.md) */
