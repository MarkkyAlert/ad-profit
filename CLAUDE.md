...
| JS ที่ต้องตรงกับ PHP (อ่านจำนวนเงิน / วันที่กำกวม / แยกหัวตาราง) + ตรวจว่าไม่มีฟังก์ชันที่เรียกแล้วไม่มีนิยาม | ครอบแล้ว (`BrowserScriptParityTest` — ดึงฟังก์ชันจาก `add-record.php` ไปรันด้วย node แล้วเทียบกับ PHP) |
