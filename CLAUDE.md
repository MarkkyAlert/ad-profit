...
- ⚠️ **"เดือนนี้" ตัดที่วันนี้ — แต่ไม่ใช่ทุกที่ กติกาต่างกันโดยตั้งใจ**
  ...
  · **ไม่ตัด (ตั้งใจ):** ยอดรวมทั้งปีและตารางรายเดือนของหน้ารายปี/Excel — เพราะแผ่น "รายวัน" ในไฟล์เดียวกันไล่ทุกวันรวมวันล่วงหน้า ถ้ายอดรวมไม่นับด้วย เอาแถวในแผ่นมาบวกเองจะไม่เท่ากับยอดรวมที่พิมพ์ไว้ (`XlsxAnnualParityTest` ล็อกไว้ พร้อมคอมเมนต์ `ล่วงหน้าในเดือนนี้ — ต้องนับ`)
  · เกิดขึ้นจริงตอนแก้กว้างเกินไป: ตัดทั้งหน้ารายปี → เทสต์ Excel แดงทันที
