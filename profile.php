...
<section class="section-card p-5">
    ...
    <?php if ($pendingEmailChange !== null): ?>
        <div class="mt-4 rounded-2xl border border-amber-400/30 bg-amber-500/10 px-4 py-3 text-sm">
            <?php /* ⚠️ ห้ามเขียนว่า "ส่งลิงก์แล้ว" — แถบนี้อ่านจากตารางคำขอ ซึ่งมีแถวอยู่แม้ตอนที่
                        ส่งจดหมายไม่ออก · เคยขึ้นคู่กับ toast แดง "ส่งอีเมลยืนยันไม่สำเร็จ"
                        บนจอเดียวกัน ผู้ใช้จึงไม่รู้ว่าตกลงส่งหรือไม่ส่ง */ ?>
            ...
            <p class="mt-1 text-slate-300">
                ...
                — อีเมลจะเปลี่ยนเมื่อกดลิงก์ยืนยันในกล่องจดหมายนั้น
            </p>
